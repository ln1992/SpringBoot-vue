...
import com.douyu.springboot_vue.entities.ProcessDiagram;
import com.douyu.springboot_vue.service.ProcessDiagramService;
import com.douyu.springboot_vue.repository.ProcessDiagramRepository;
...
public abstract class ProcessDiagramServiceImpl<T extends ProcessDiagram, R extends org.springframework.data.jpa.repository.JpaRepository<T, Long>>
    ...
    public List<Long> findAllDiagramVersions() {
        ...
        return ((ProcessDiagramRepository<T>) repository).findAllVersions();
    }
}